...
date: "Last compiled on 2022-03-05 19:18:10"
mainfont: Montserrat
...
(ref:missing) Temporal coverage of each municipality on a daily scale.
...
(ref:seasonal) Seasonal distribution of catch weight and nutrients. The values are normalized on the number of trips of each municipality indicating the average monthly yield independently from the sample size.
...
(ref:seasonal-2) Seasonal distribution of catch weight and nutrients. The values are normalized on the number of trips of each municipality indicating the average monthly yield independently from the sample size.
