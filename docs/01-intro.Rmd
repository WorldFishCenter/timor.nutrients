...
## Nutritional and weight estimation in fish catches
...
```{r echo=FALSE, fig.height=4, fig.width=8, message=FALSE, warning=FALSE, fig.cap='Here is a nice figure!', out.width='80%', fig.asp=.75, fig.align='center'}
setwd("../..")
pars <- read_config()
