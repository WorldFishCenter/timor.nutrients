...
```{r echo=TRUE, fig.cap="Fish groups' nutrional contribution to RNI.", fig.height=8, fig.width=7, message=FALSE, warning=FALSE, out.width='80%'}
library(ggplot2)
library(ggforce)
...
```{r echo=TRUE, fig.cap="Sankey diagram showing the relative distribution of key nutrients across various marine habitats and the corresponding extraction by different fishing gear types used in Timor-Est small-scale fisheries.", fig.height=8, fig.width=7, message=FALSE, warning=FALSE}
parallel_plot <-
