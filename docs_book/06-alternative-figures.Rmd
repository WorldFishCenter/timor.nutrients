...
```{r echo=FALSE, fig.cap="To define", fig.height=8, fig.width=9.5, message=FALSE, warning=FALSE}
library(ggplot2)
...
x_label <- cowplot::draw_label("Cumulative nutrient density score", x = 0.55, y = 0.02)

cowplot::plot_grid(
  legends + theme(plot.margin = unit(c(0, 0.6, 0, 1.5), "cm")),
  p2,
  nrow = 2,
  align = "h",
  rel_heights = c(0.1, 1)
