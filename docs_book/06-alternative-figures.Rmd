...
groups_plot <-
  ...
  labs(y = "Tons (2018-2023)", x = "Functional group", fill = "Fish group", subtitle = "Nutrient yield") +
  theme(
    legend.position = "",
    panel.grid = element_blank(),
...
```{r echo=FALSE, fig.cap="To define", message=FALSE, warning=FALSE}
...
ggplot() +
  ...
  annotate(
    "text",
    x = 125.9, y = -8.2, label = "Atauro 1,067.9%", size = 3, color = "firebrick", fontface = "bold"
  ) +
  # annotate(
