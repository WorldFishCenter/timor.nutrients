...
```{r echo=FALSE, fig.cap="To define", fig.height=4, fig.width=9, message=FALSE, warning=FALSE}
importance_ag <-
...
```{r eval=FALSE, fig.cap="Differential influence of mesh size on nutritional profile predictions across habitats. The figure compiles subplots for five distinct nutritional profiles (FNP1-FNP5) as predicted by gill net XGBoost models", fig.height=7, fig.width=8, message=FALSE, warning=FALSE, include=FALSE}
# atauro gn
