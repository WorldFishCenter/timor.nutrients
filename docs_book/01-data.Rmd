...
```{r nutdispersion, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap="Distribution of nutrients' concentration for each fish group. Dots represent the median, fig.height=4, fig.width=10, message=FALSE, warning=FALSE, bars represent the 95% confidence interval.", out.width='80%'}
