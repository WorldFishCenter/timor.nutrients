...
annotation_data <- data.frame(
  ...
  x = 0.175,
  y = 110,
  label = 'Using a 50.8 mm mesh size\nin reef habitats increases\nthe likelihood of achieving an NP-3 profile'
)
...
sha_Mgn %>%
  ...
  facet_grid(. ~ factor(profile, levels = c("NP-3", "NP-1", "NP-2")), scales = "free") +
  ...
  ggplot2::geom_curve(
    data = annotation_data,
    aes(x = 0.325, y = 57.5, xend = 0.29, yend = 90),
    curvature = -0.1,
    color = 'black',
    linewidth = 0.3,
    arrow = arrow(length = unit(0.25, 'cm')),
